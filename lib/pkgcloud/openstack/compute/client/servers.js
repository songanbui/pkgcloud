 ...
 * @param {Boolean}         [details.config_drive]   optional drive configuration
 * @param callback
 * @returns {request|*}
 */
exports.createServer = function createServer(details, callback) {
  ...
  if ('config_drive' in details && typeof details.config_drive === 'boolean') {
    createOptions.body.server.config_drive = details.config_drive;
  } else {
    createOptions.body.server.config_drive = false;
  }
...
/**
 * client.getVNCConsole
 *
 * @description Get a VNC Console url for the provided server
 *
 * @param {String|Object}   server          The server ID or server to stop
 * @param {String}          console_type    The console type ('novnc' or 'xvpvnc')
 * @param {function}        callback
 * @returns {*}
 */
exports.getVNCConsole = function (server, console_type, callback) {
  this._doServerAction(server,
