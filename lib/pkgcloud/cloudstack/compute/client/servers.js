 ...
 * @returns {request|*}
 */
exports.createServer = function createServer(details, callback, progressCallback) {
        ...
        if(err) { return callback(err) ; }
            ...
            return self._request({
                ...
                if(err) { return callback(err); }
                    ...
                    var result = (response.jobresult && response.jobresult.virtualmachine) ?
                        new compute.Server(self, response.jobresult.virtualmachine) :
                        new compute.Server(self, params)  ;
 ...
 * @returns {request|*}
 */
exports.destroyServer = function destroyServer(server, callback, progressCallback) {
    var self = this,
 ...
 * @returns {*}
 */
exports.rebootServer = function rebootServer(server, callback, progressCallback) {
    var self = this,
        serverId = server instanceof base.Server ? server.id : server;
    return this._request({
 ...
 * @returns {*}
 */
exports.startServer = function startServer(server, callback, progressCallback) {
    var self = this,
        serverId = server instanceof base.Server ? server.id : server;
    return this._request({
 ...
 * @returns {*}
 */
exports.stopServer = function stopServer(server, callback, progressCallback) {
    var self = this,
        serverId = server instanceof base.Server ? server.id : server;
    return this._request({
