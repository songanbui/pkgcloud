...
Server.prototype._setProperties = function (details) {
  ...
  if (roleInstance) {
       if (Array.isArray(roleInstance.InstanceEndpoints.InstanceEndpoint) && (roleInstance.InstanceEndpoints.InstanceEndpoint.length > 0)) {
         addresses.public.push(roleInstance.InstanceEndpoints.InstanceEndpoint[0].Vip);
     }
     else {
